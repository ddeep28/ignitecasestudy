    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="dist/img/deep.jpg" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="index1.php"><i class="fa fa-circle-o"></i> Dashboard IGNITE</a></li>
      ...
      <!--  <li class="treeview">
        ...
        <li>
          <a href="addevents.php">
            <i class="fa fa-fw fa-calendar-plus-o"></i> <span>Add Events</span>
            <span class="pull-right-container">
		...
		<li>
          <a href="addgallery.php">
            <i class="fa fa-fw fa-camera"></i> <span>Add Gallery</span>
            <span class="pull-right-container">
             <!-- <small class="label pull-right bg-green">new</small>-->
            </span>
          </a>
		...
		<li>
          <a href="addteam.php">
            <i class="ion ion-person-add"></i> <span>Add Team</span>
            <span class="pull-right-container">
             <!-- <small class="label pull-right bg-green">new</small>-->
            </span>
          </a>
		...
		<li>
          <a href="addschedule.php">
            <i class="fa fa-calendar"></i> <span>Add Schedule</span>
            <span class="pull-right-container">
             <!-- <small class="label pull-right bg-green">new</small>-->
            </span>
          </a>
        ...
        <li>
          <a href="contactuslist.php">
            <i class="fa fa-envelope-o"></i> <span>Contact Us List</span>
            <span class="pull-right-container">
             <!-- <small class="label pull-right bg-green">new</small>-->
            </span>
          </a>
          ...
          <li>
          <a href="registerslist.php">
            <i class="fa fa-fw fa-user"></i> <span>Registered Students</span>
            <span class="pull-right-container">
             <!-- <small class="label pull-right bg-green">new</small>-->
            </span>
          </a>
