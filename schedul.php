...
<div class="table">
				  ...
				  while($row=$stmt->fetch())
				  {
						...
						echo "<div class=cell data-title=Event>";
								echo $row['event'] ;
						echo "</div>";
						
						echo "<div class=cell data-title=EventStartTime>";
								echo $row['etime']; 
						echo "</div>";
						
						echo "<div class=cell data-title=EventEndTime>";
								echo $row['etimeend']; 
						echo "</div>";
