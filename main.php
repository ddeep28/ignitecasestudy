...
<div class="options-wthree">
    ...
    <div class="container">
		<ul>
			<li>
			<a href="schedule.php" class="opt-grids">
			...
			<li>
			<a href="team.php" class="opt-grids">
				<div class="icon-agileits-w3layouts">
			...
			<li>
			<a href="gallery.php" class="opt-grids">
				<div class="icon-agileits-w3layouts">
			...
			<li>
			<a href="events.php" class="opt-grids">
				<div class="icon-agileits-w3layouts">
			...
			<li>
			<a href="locations.php" class="opt-grids">
				<div class="icon-agileits-w3layouts">
					<i class="fa fa-map-marker" aria-hidden="true"></i>
				</div>
				<div class="opt-text-w3layouts">
			...
			<li>
			<a href="contact.php" class="opt-grids">
				<div class="icon-agileits-w3layouts">
