...
<head>
	<meta charset="utf-8">
	<title>Ignite | Register </title>
	<!-- Mobile Specific Metas -->
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
	<!-- Font-->
	<link rel="stylesheet" type="text/css" href="css1/opensans-font.css">
...
<body class="form-v4">
	...
	<div class="page-content">
		...
		<div class="form-v4-content">
			...
			<form class="form-detail" action="phpfile/register_process.php" method="post" id="myform">
				<h2>REGISTER FORM</h2>
